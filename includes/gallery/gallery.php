...
add_shortcode('gallery', 'multidealer_parse_gallery_shortcode');
function multidealer_parse_gallery_shortcode($atts)
{
    wp_register_script('flexslider', MULTIDEALERURL .
