		...
		switch($this->page->type) {
			...
			case 'submenu':
               ...
               // 'admin.php?page=multi-dealer-plugin',
				...
				break;
     // add_submenu_page('multi_dealer_plugin', 'Do Stuff', 'Do Stuff', 'manage_options', 'myplugin-dostuff-page2', 'page_callback22');
        //http://autosellerplugin.com/wp-admin/admin.php?page=multi_dealer_plugin      
 			case 'submenu2':
               add_submenu_page( 
               // 'edit.php?post_type=products',
               //   'admin.php?page=multi_dealer_plugin',
              // 'multi_dealer_plugin', //
              // 'admin.php?page=multi_dealer_plugin',
              '', // 'NULL,
              // 'multidealer/multidealer.php',
                'Settings1', 
               'Settings2',  
               'manage_options', 
               'md_settings',
